    ...
    <div class="container">
        ...
        <div class="col-md-12">
            <div class="container rounded bg-white mt-5 mb-5">
                <div class="row">
                    <div class="col-md-12"> {{ __('Date du prochain Rendez-vous : ') }} <strong>15/03/2022 </strong> avec : Fabrice</div>
                    <div class="col-md-3 border-right">
                        ...
                        <div class="p-3 py-1">
                            ...
                            <div class="col-md-12">
                                <label class="labels">Expérience en conception</label><input
                                    type="text" class="form-control" placeholder="Plus de détail sur Experience" value="">
                            </div>
                            <br>
                        </div>
                        <div class="">
                            <div class="col-md-12">
                                <label class="labels">Dernier commentaire sur l'individu</label><input
                                    type="text" class="form-control" placeholder="Plus de détail sur Experience" value="" readonly="readonly" style="min-height: 100px">
                            </div>
                            <br>
                        </div>
                    </div>
                        ...
                        <div class="p-3 py-5">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-6"><label class="labels">Nom de famille</label><input
                                        type="text" class="form-control" value="{{ $individu->first()->lastName_individu }}" placeholder="nomDeFamille"></div>
                            </div>
                            <div class="row mt-3">
                                ...
                                <div class="col-md-12"><label class="labels">Commune</label><input type="text"
                                        class="form-control" placeholder="entrer une commune" value="{{ $individu->first()->regionBirth_individu }}"></div>
                                ...
                                <div class="d-flex justify-content-between align-items-center experience">
                                    ...
                                    <ul class="nav nav-tabs">
                                        <li class="nav-item dropdown">
                                          <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">Ajouter une fiche</a>
                                          <ul class="dropdown-menu">
                                            @if($fichePaios !== "Aucune fiche Paio") 
                                            <li><a class="dropdown-item" href="ficheCandidate/{{ $fichePaios->first()->iopa_fiche_type_paio_id }}" style="background-color: #6e7175 !important;color:white;">PAIO : Il existe déja une fiche PAIO</a></li>
                                            @else
                                            <li><a class="dropdown-item" href="ficheCandidate/" >PAIO : Fiche de suivi Candidat</a></li>
                                            @endif 
                                            <li><a class="dropdown-item" href="#">Vae : Fiche analyse de demande</a></li>
                                            <li><a class="dropdown-item" href="#">Atelier : Questionaire de motivation</a></li>
                                            <li><a class="dropdown-item" href="#">Spot : Fiche d'inscription spot</a></li>
                                            <li><hr class="dropdown-divider"></li>
                                            <li><a class="dropdown-item" href="#">Spip : Fiche de suivi spip</a></li>
                                          </ul>
                                        </li>
                                      </ul></div><br>
                                        ...
                                        <section>
                                            <div class="container py-3">
                                                ...
                                                <p colspan="9" class="table-active text-center" style="border: 1px solid darkgreen; background-color: #6e7175 !important;color:white;padding:5px;">Aucune fiche Atelier</p>
                                                <span style="text-decoration-line: underline;">Fiche type : Spot</span>     
                                                <p colspan="9" class="table-active text-center" style="border: 1px solid darkgreen; background-color: #6e7175 !important;color:white;padding:5px;">Aucune inscription Spot</p>    
                                                <span style="text-decoration-line: underline;">Fiche type : Spip</span>     
                                                <p colspan="9" class="table-active text-center" style="border: 1px solid darkgreen; background-color: #6e7175 !important;color:white;padding:5px;">Aucune fiche Spip</p>                            
                                              </div>
                                            </div>
                                          </section>
                            </div>
