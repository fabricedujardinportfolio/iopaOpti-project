                            ...
                            <div class="p-3 py-5">
                                ...
                                <div class="row">
                                    ...
                                    @if ($individu->first()->situationProStatu_individu !== 'non-définie')
                                        ...
                                        <div class="form-check mx-2 col-md-4">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input class="form-check-input" type="radio"
                                                        name="demandeurEmploiChomage" id="demandeurEmploiChomage"
                                                        value="demandeurEmploiChomage">
                                                    <label class="form-check-label" for="demandeurEmploiChomage">
                                                        Indémité de chomage
                                                    </label>
                                                </div>
                                                <div class="col-md-12">
