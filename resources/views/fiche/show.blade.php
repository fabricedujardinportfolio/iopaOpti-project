            ...
            <div class="container rounded bg-white mt-5 mb-5">
                <div class="row">
                    ...
                    <div class="col-md-3 border-right">
                        <div class="d-flex flex-column align-items-center text-center p-3 py-3" id="topInfo"><img
                        ...
                        @if ($individu->first()->permisDeConduire_individu !== 'non-définie')
                                                    @if ($individu->first()->permisDeConduire_individu === 'oui' || $individu->first()->permisDeConduire_individu === 'encours')
                                                    <button type="button" id="formPermis" class="btn btn-primary" data-bs-toggle="modal"
                                                    data-bs-target="#modalPermis">
                                                    Rajouter un permis
                                                </button>
                        
                                                <!-- Modal -->
                                                <div class="modal fade" id="modalPermis" tabindex="-1" aria-labelledby="modalPermisLabel"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="modalPermisLabel">
                                                                    Permis
                                                                </h5>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                                    aria-label="Close"></button>
                                                            </div>
                                                            <form baction="{{ route('updateFiche', $individu->first()->iopa_individu_id) }}"
                                                                method="post" id="formPermi">
                                                                @csrf
                                                                <div class="modal-body">
                                                                    <input type="text" class="form-control" id="permis"
                                                                        name="iopa_individupermi_namesend" placeholder="Nom du permis" required>
                                                                    <input type="text" class="form-control my-1 d-none" id="iopa_individu_id"
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="submit" class="btn btn-primary" name="permis"
                                                                        value="permis">Sauvegarder</button>
                                                                </div>
                                                        ...
                                                        @if ($permis !== 'Aucun permi ?')
                                                            <ul class="list-group">
                                                                @foreach ($permis as $permi)
                                                                    <li class="list-group-item">
                                                                            <form class="row"
                                                                                action="{{ route('updatePermiFiche', $permi->first()->iopa_individupermi_id) }}"
                                                                                method="post" id="">
                                                                                @csrf
                                                                                <div class="col-md-7">
                                                                                    <input type="text"
                                                                                        class="form-control"
                                                                                        id="diplome"
                                                                                        placeholder="Nom du permi"
                                                                                        value="{{ $permi->iopa_individupermi_name }}"
                                                                                        name="iopa_individupermi_name">
                                                                                </div>
                                                                                <div class="col-md-5 row">
                                                                                    <div
                                                                                        class="col-md-4 " style="width: auto;">
                                                                                        <a href="{{ route('destroyPermi', $permi->iopa_individupermi_id) }}"
                                                                                    ...
                                                                                    <div
                                                                                        class="col-md-4">
                                                                                        <a href="{{ route('updatePermiFiche', $permi->iopa_individupermi_id) }}"
                                                                                            style="text-decoration: none;">
                                                                                            <button
                                                                                                type="submit"
                                                                                                class="btn btn-primary w-auto"
                                                                                                name="diplomeUpdate{{ $permi->iopa_individupermi_id }}"
                                                                                                value="diplomeupdate{{ $permi->iopa_individupermi_id }}">v</button>
                                                                                        </a>
                                                                                    </div>
                                                                                </div>
                                                                        </form>
                                                    ...
                                                    @endif
                                                @endif
                        <form action="{{ route('updateFiche', $individu->first()->iopa_individu_id) }}" method="post"
                            id="form">
                            @csrf
                    </div>
                        ...
                        <div class="p-3 py-5">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-6"><label class="labels">Nationalité :</label><input
                                        ...
                                        value="{{ $individu->first()->nationality_individu }}" placeholder="Nationalité"
                                        name="nationality_individu" required></div>
                            </div>
                            <div class="row">
                                ...
                                <div class=" col-12 col-md-6 d-md-flex d-block" style="align-self: center;">
                                    ...
                                    <div class="form-check m-1">
                                        <input class="form-check-input" type="radio" name="familyStatus_individu" id="marie"
                                            value="marie"
                                ...
                                <div class="col-md-3"><label class="labels">Lieu de naissance :</label>
                                    <input type="text" class="form-control" placeholder="Lieu de naissance de Individu"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6"><label class="labels">Code postal :
                                    </label><input type="text" class="form-control" placeholder="entrer un code postal"
                                ...
                                <div class="col-md-6"><label class="labels">Email : Identifiant de
                                        ...
                                        value="{{ $individu->first()->email_individu }}" required name="email_individu">
                                </div>
                            </div>
                            <div class="row my-2" style="background-color: #f5faff" id="statuProfiles">
                                ...
                                <div class="col-md-3 form-check mx-2">
                                    <input class="form-check-input" type="radio" name="situationProStatu_individu" id="CDD"
                                        value="CDD"
                                ...
                                <div class="form-check mx-2 col-md-3">
                                    <input class="form-check-input" type="radio" name="situationProStatu_individu" id="CDI"
                                        value="CDI"
                                            ...
                                            <div class="row">
                                                            ...
                                                            <div class="row">
                                                                <div class="form-check mx-2 col-md-5">
                                                                    ...
                                                                    @else
                                                                        <input class="form-check-input" type="radio"
                                                                            name="chomageDemendeur_individu"
                                                                            id="chomageDemendeur_individuOui" value="oui">
                                                                    @endif
                                                                </div>
                                                                ...
                                                                <div class="form-check mx-2 col-md-5">
                                                                    ...
                                                                    @else
                                                                        <input class="form-check-input" type="radio"
                                                                            name="chomageDemendeur_individu"
                                                                            id="chomageDemendeur_individuNon" value="non"
                                                                            checked>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        ...
                                                        @else
                                                            <div class="col-md-6 d-none">
                                                                <label class="labels" style="color:#acaeb1;">Pour
                                                                    la période du :
                                                                </label><input type="text" class="form-control"
                                                                    placeholder="entrer un code postal"
                                                                    value="{{ $individu->first()->chomageDemendeurPeriodeDeb_individu }}"
                                                            ...
                                                            <div class="col-md-6 d-none">
                                                                <label class="labels" style="color:#acaeb1;">:au
                                                                </label><input type="text" class="form-control"
                                                                    placeholder="entrer un code postal"
                                                                    value="{{ $individu->first()->chomageDemendeurPeriodeFin_individu }}"
                                                                    name="chomageDemendeurPeriodeFin_individu" required
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check mx-2 col-md-5">
                                                ...
                                                @else
                                                    <input class="form-check-input" type="radio"
                                                        name="validiterCafat_individu" id="validiterCafatOui" value="oui">
                                                @endauth
                                        </div>
                                        <div class="form-check mx-2 col-md-5">
                                            ...
                                            @else
                                                <input class="form-check-input" type="radio"
                                                    name="validiterCafat_individu" id="validiterCafatNon" value="non"
                                                    checked>
                                            @endif
                                        </div>
                                    </div>
                                                        ...
                                                        @if ($individu->first()->permisDeConduire_individu !== 'non-définie')
                                                            @if ($individu->first()->permisDeConduire_individu === 'oui')
                                                                <input class="form-check-input" type="radio"
                                                                    ...
                                                                    id="permisDeConduire_individu" value="oui"
                                                                    checked>
                                                            @else
                                                                <input class="form-check-input" type="radio"
                                                                    name="permisDeConduire_individu"
                                                ...
                                                <div class="form-check mx-2 col-md-5">
                                                    ...
                                                    @if ($individu->first()->permisDeConduire_individu !== 'non-définie')
                                                        @if ($individu->first()->permisDeConduire_individu === 'non')
                                                            <input class="form-check-input" type="radio"
                                                                name="permisDeConduire_individu"
                                                                id="permisDeConduire_individunon" value="non"
                                                                checked>
                                                        @else
                                                            <input class="form-check-input" type="radio"
                                                                name="permisDeConduire_individu"
                                            ...
                                            <div class="row">
                                                <div class="col-md-7" style="align-self: center;">
                                                    <label class="form-check-label" for="DernierClasse"
                                                        id="dernierClasse">Dernière classe ou dernière
                                                        formation
                                                        suivie (date)
                                                        :</label>
                                                </div>
                                ...
                                <div class="col-md-12 mt-1">
                                    <div class="col-md-12 mb-2">
                                        <label class="form-check-label" style="vertical-align: middle;">
                                            <strong class="h4">Parcours scolaire et formations
                                                :</strong>
                                        </label>
                                        <button type="button" id="formDiplome" class="btn btn-primary"
                                        ...
                                        <div class="modal fade" id="exampleModal" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form
                                                        action="{{ route('updateFiche', $individu->first()->iopa_individu_id) }}"
                                                        method="post" id="form">
                                                        @csrf
                                                        <div class="modal-body">
                                                            <input type="text" class="form-control"
                                    ...
                                    <div class="col-md-12 mt-1">
                                        <div class="col-md-12 mb-2">
                                            <label class="form-check-label" style="vertical-align: middle;">
                                                <strong class="h4">Parcours professionnel : Expériences et satges
                                                    :</strong>
                                            </label>
                                            <button type="button" id="formExperience" class="btn btn-primary"
                                                data-bs-toggle="modal" data-bs-target="#experience">
                                                Rajouter une expérience
                                            </button>
    
                                            <!-- Modal -->
                                            <div class="modal fade" id="experience" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form
                                                            ...
                                                            <div class="modal-body">
                                                                <input type="text" class="form-control"
                                                                    id="experienceAnnee" name="iopa_experienceIndividu_annee"
                                                                    placeholder="Année(s) de l'expérience" required>
                                                                <input type="text" class="form-control my-1"
                                                                    id="experienceMetier" name="iopa_experienceIndividu_metier"
                                                                    placeholder="Nom du métier" required>
                                                                <input type="text" class="form-control my-1"
                                                                    id="entrepriseExperience" placeholder="Entreprise"
                                                                    name="iopa_experienceIndividu_entreprise" required>
                                                                    <input type="text" class="form-control my-1"
                                                                    id="dureeExperience" placeholder="Durée"
                                                                    name="iopa_experienceIndividu_duree" required>
                                                                <input type="text" class="form-control my-1 d-none"
                                                                    id="individuExperience" placeholder="Année(s)"
                                                                    name="iopa_individu_id"
                                                                    value="{{ $individu->first()->iopa_individu_id }}"
                                                                    required>
                                                            </div>
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submit" class="btn btn-primary"
                                                                    name="experience"
                                                                    value="experience">Sauvegarder</button>
                                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                @if ($experiences !== 'Aucune experience ?')
                                                    <table class="table">
                                                        <thead>
                                                            <tr>
                                                                <th>Année(s)</th>
                                                                <th>Métier de expérience</th>
                                                                <th>Entreprise de expérience</th>
                                                                <th>Durée</th>
                                                                <th>Action</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            @foreach ($experiences as $experience)
                                                                <tr>
                                                                    <form
                                                                        action="{{ route('updateExperFiche', $experience->first()->iopa_experienceIndividu_id) }}"
                                                                        method="post" id="">
                                                                        @csrf
                                                                        <td>
                                                                            <input type="text" class="form-control"
                                                                                id="diplome"
                                                                                placeholder="Année de expérience"
                                                                                value="{{ $experience->iopa_experienceIndividu_annee }}"
                                                                                name="iopa_experienceIndividu_annee">
                                                                        </td>
                                                                        <td>
                                                                            <input type="text" class="form-control"
                                                                                id="annee" placeholder="Métier de expérience"
                                                                                value="{{ $experience->iopa_experienceIndividu_metier }}"
                                                                                name="iopa_experienceIndividu_metier">
                                                                        </td>
                                                                        <td>
                                                                            <input type="text" class="form-control"
                                                                                id="annee" placeholder="Entreprise de expérience"
                                                                                value="{{ $experience->iopa_experienceIndividu_entreprise }}"
                                                                                name="iopa_experienceIndividu_entreprise">
                                                                        </td>
                                                                        <td>
                                                                            <input type="text" class="form-control"
                                                                                id="annee" placeholder="Durée de expérience"
                                                                                value="{{ $experience->iopa_experienceIndividu_duree }}"
                                                                                name="iopa_experienceIndividu_duree">
                                                                        </td>
                                                                        <td class="d-none">
                                                                            <input type="text" class="form-control"
                                                                                id="annee" placeholder="Durée de expérience"
                                                                        ...
                                                                        <td class="w-25">
                                                                            <span>
                                                                                <a href="{{ route('destroyExper', $experience->iopa_experienceIndividu_id) }}"
                                                                                    style="text-decoration: none;">
                                                                                    <button type="button"
                                                                                        class="btn btn-danger w-25"
                                                                                        data-bs-dismiss="modal">X</button>
                                                                            ...
                                                                            <span>
                                                                                <a href="{{ route('updateExperFiche', $experience->iopa_experienceIndividu_id) }}"
                                                                                    style="text-decoration: none;">
                                                                                    <button type="submit"
                                                                                        class="btn btn-primary w-50"
                                                                                        name="diplomeUpdate{{ $experience->iopa_experienceIndividu_id }}"
                                                                                        value="diplomeupdate{{ $experience->iopa_experienceIndividu_id }}">actualiser</button>
                                                                                </a>
                                                                            </span>
                                                                        </td>
                                                                    </form>
                                    ...
                                    <div class="card my-2" style="background-color: #e3b482;">
                                        <div class="row ">
                                            <div class="col-md-12 px-3 py-2">
                                                <div class="card-block px-3">
                                                    <h4 class="card-title">
                                                        {{ $ficheAtelier->iopa_fiche_type_atelier_title }}
                                                    </h4>
                                                    <p class="card-text">Consectetur adipiscing elit, sed
                                                        do eiusmod tempor incididunt ut labore et dolore magna
                                                        aliqua. Ut enim ad minim veniam, quis nostrud
